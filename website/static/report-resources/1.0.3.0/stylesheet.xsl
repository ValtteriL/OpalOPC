  ...
  <xsl:template match="/">
    <html
      ...
      <head>
        ...
        <!-- Link favicon CSS -->
        <link rel="icon"
          href="https://opalopc.com/report-resources/1.0.3.0/assets/images/favicon.png"
          type="image/png" sizes="16x16"></link>

        <!-- Link Bootstrap CSS -->
        <link href="https://opalopc.com/report-resources/1.0.3.0/assets/css/bootstrap.min.css"
          rel="stylesheet"></link>
        ...
        <!-- Link Custom CSS -->
        <link href="https://opalopc.com/report-resources/1.0.3.0/assets/scss/style.css"
          rel="stylesheet"></link>
      ...
      <body dir="ltr">
        ...
        <header>
          <div class="container">
            ...
            <div class="logo">
              <img src="https://opalopc.com/report-resources/1.0.3.0/assets/images/logo.svg"
                alt=""></img>
            </div>
    ...
    2</xsl:if>
        ...
        <!-- JS -->
        <script src="https://opalopc.com/report-resources/1.0.3.0/assets/js/popper.min.js"></script>
        <script src="https://opalopc.com/report-resources/1.0.3.0/assets/js/bootstrap.min.js"></script>
        <script src="https://opalopc.com/report-resources/1.0.3.0/assets/js/jquery.min.js"></script>
